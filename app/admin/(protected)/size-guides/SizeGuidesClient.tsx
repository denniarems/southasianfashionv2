...
import { deleteItem } from '@/app/actions/dashboard'
import { ConfirmDialog } from '@/components/ui/confirm-dialog'
import { ItemDialog } from '../components/ItemDialog'
import { formatCad } from '@/lib/currency'


export default function SizeGuidesClient({ items, initialProducts, initialCollections, initialCategories, initialSizeGuides }: any) {
	const [dlg, setDlg] = useState({ open: false, type: 'size-guides', mode: 'add', data: null as any })
						...
						>
							<div className="flex justify-between items-center mb-6">
								<h2 className="font-heading text-xl text-stone-900">
									Size Guides ({activeItems.length})
								</h2>
								<Button
